...
# MAGIC # Users 
# MAGIC
# MAGIC Plot the details of items purchased, categorized by type, size, and quality, and compile unique preferences for each user.
# MAGIC
# MAGIC 1. Extract item details and split them for analysis.
# MAGIC 2. Categorize and extract size and quality for mattresses and pillows.
# MAGIC 3. Combine data for both product types.
# MAGIC 4. List unique size and quality options for each user.
